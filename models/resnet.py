...
def ResNet34(name='res18'):
    return ResNet(BasicBlock, [3, 4, 6, 3], name=name)


def ResNet50():
    return ResNet(Bottleneck, [3, 4, 6, 3], name='res50')


def ResNet101():
    return ResNet(Bottleneck, [3, 4, 23, 3], name='res101')


def ResNet152():
    return ResNet(Bottleneck, [3, 8, 36, 3], name='res152')
